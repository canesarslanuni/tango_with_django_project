...
# This helper function takes the request and response objects – because we want to be able to access the incoming cookies from the request, and add or update cookies in the response
